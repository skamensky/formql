...
-- All tables live in the "crm" schema so data persists across container restarts.

-- Mock auth() function (used by Supabase-based environments)
...
CREATE TABLE IF NOT EXISTS rep_link (
  id BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM app_user LIMIT 1) THEN RETURN; END IF;
  ...
  INSERT INTO rep_link (rep_id, opportunity_id, role, commission_percentage, commission_amount, paid_date) VALUES
    ...
    (2, 4, 'Listing Agent', 35.0, NULL, NULL),
    ...
    (9, 9, 'Buyer Agent', 50.0, NULL, NULL),
    (11, 10, 'Buyer Agent', 50.0, 7125, '2024-02-05'),
    (2, 10, 'Listing Agent', 40.0, 5700, '2024-02-05'),
    (5, 10, 'Referral Fee', 15.0, 2137.50, '2024-02-05'),
    (11, 11, 'Buyer Agent', 50.0, NULL, NULL),
    ...
    (9, 18, 'Listing Agent', 35.0, 1680, '2024-01-30'),
    (10, 20, 'Showing Agent', 25.0, NULL, NULL),
    (8, 21, 'Buyer Agent', 30.0, NULL, NULL),
    (8, 21, 'Listing Agent', 70.0, NULL, NULL),
    (12, 22, 'Buyer Agent', 50.0, NULL, NULL),
    (12, 22, 'Builder Bonus', 15.0, NULL, NULL),
    ...
    (4, 25, 'Estate Specialist', 25.0, NULL, NULL),
    (11, 26, 'Buyer Agent', 50.0, NULL, NULL),
    (11, 27, 'Buyer Agent', 60.0, NULL, NULL),
    (3, 27, 'Listing Agent', 40.0, NULL, NULL),
    (10, 28, 'Dual Agent', 80.0, 3720, '2024-02-05'),
    ...
    (7, 31, 'Buyer Agent', 30.0, NULL, NULL),
    ...
    (1, 35, 'Listing Agent', 50.0, NULL, NULL),
    (7, 5, 'Luxury Bonus', 12.0, NULL, NULL),
    (7, 6, 'High-Value Deal Bonus', 8.0, NULL, NULL),
    (10, 1, 'Investment Volume Bonus', 3.0, 126, '2024-01-25'),
    (10, 3, 'Portfolio Bonus', 5.0, 400, '2024-01-20'),
    (10, 32, 'Investment Specialist', 10.0, 435, '2024-02-10');
END $$;
