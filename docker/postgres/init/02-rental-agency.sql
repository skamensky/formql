...
-- Rich enough to exercise branches, fleets, reps, customers, repeat business, vendors, rentals, and resale.

DROP TABLE IF EXISTS rep_link CASCADE;
DROP TABLE IF EXISTS opportunity CASCADE;
DROP TABLE IF EXISTS listing CASCADE;
DROP TABLE IF EXISTS app_user CASCADE;
DROP TABLE IF EXISTS resale_sale CASCADE;
DROP TABLE IF EXISTS rental_contract CASCADE;
DROP TABLE IF EXISTS rental_offer CASCADE;
DROP TABLE IF EXISTS customer CASCADE;
DROP TABLE IF EXISTS vehicle CASCADE;
DROP TABLE IF EXISTS vehicle_purchase CASCADE;
...
CREATE INDEX rep_branch_idx ON rep (branch_id);
CREATE INDEX vehicle_current_branch_idx ON vehicle (current_branch_id);
CREATE INDEX vehicle_vendor_idx ON vehicle (vendor_id);
CREATE INDEX customer_assigned_rep_idx ON customer (assigned_rep_id);
CREATE INDEX customer_last_contract_idx ON customer (last_contract_id);
CREATE INDEX rental_offer_customer_idx ON rental_offer (customer_id);
CREATE INDEX rental_offer_vehicle_idx ON rental_offer (vehicle_id);
CREATE INDEX rental_contract_customer_idx ON rental_contract (customer_id);
CREATE INDEX rental_contract_vehicle_idx ON rental_contract (vehicle_id);
CREATE INDEX rental_contract_offer_idx ON rental_contract (offer_id);
CREATE INDEX resale_sale_vehicle_idx ON resale_sale (vehicle_id);
CREATE INDEX resale_sale_customer_idx ON resale_sale (customer_id);
CREATE INDEX resale_sale_vendor_idx ON resale_sale (vendor_id);
